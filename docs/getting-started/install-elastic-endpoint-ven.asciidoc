...
=== To enable Full Disk Access for macOS 15 and above, you must manually approve {elastic-endpoint}. 
. Open the *System Settings* application.
. In the left pane, search for *Login Items & Extensions*.
+ 
**screenshot**
+
. Scroll to the lower "Extensions" section
. Next to "Endpoint Security Extensions" select the "i" 
. Activate the toggle next to "ElasticEndpoint.app"
+ 
**screenshot**
+


=== To enable Full Disk Access for macOS 14 and below, you must manually approve {elastic-endpoint}. 
